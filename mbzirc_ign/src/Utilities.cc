...
template <typename T>T
  SdfParam(const sdf::Element& _sdf, const std::string &_paramName, \
           const T &_defaultVal)
{
...
ignition::math::Vector2d Utilities::SdfParamVector2(const sdf::Element& _sdf,
...
ignition::math::Vector3d Utilities::SdfParamVector3(const sdf::Element& _sdf,
